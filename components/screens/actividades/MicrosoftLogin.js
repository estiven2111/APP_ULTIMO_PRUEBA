...
useEffect(()=>{
 ...
 const execute = async () =>{
   const auth = await axios.get("https://syncronizabackup-production.up.railway.app/user/api/auth")
let resp = auth.data
  setToken(resp)
 }
  ...
  return (
    <View>
      <TouchableOpacity
        ...
        // disabled={fillData}
      >
        <Text style={styles.textLogin}>Autenticar</Text>
      </TouchableOpacity>
